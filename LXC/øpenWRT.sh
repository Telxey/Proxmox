...
function advanced_settings() {
  ...
  if CORE_COUNT=$(whiptail --backtitle "Telxey Proxmox Scripts" --inputbox "Allocate CPU Cores" 8 58 1 --title "CORE COUNT" --cancel-button Exit-Script 3>&1 1>&2 2>&3); then
